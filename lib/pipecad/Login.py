...
from pipecad import *
from pipecad.DataManager import DataManager
import omp
...
class LoginDialog(QDialog):
    ...
    def setupUi( self ):
        ...
        self.buttonDataManager = QPushButton(QT_TRANSLATE_NOOP("Login", "Open Data Manager"))
        ...
        self.verticalLayout.addWidget(self.buttonDataManager)
        ...
        self.buttonDataManager.clicked.connect( self.openDataManager )
